...
namespace Quhinja.Data.Migrations
{
    ...
    [Migration("20210618063616_ivana1")]
    partial class ivana1
    {
            ...
            modelBuilder.Entity("Quhinja.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "af13f215-150a-4325-ac2b-23e62d090bed",
                            Name = "admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "1a04bc14-e214-44c8-a38b-8fe95aad1b37",
                            Name = "user",
                            NormalizedName = "USER",
            ...
            modelBuilder.Entity("Quhinja.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "76412921-99f7-4872-a2a9-82b46b3540ab",
                            DateOfBirth = new DateTime(2021, 6, 18, 8, 36, 13, 762, DateTimeKind.Local).AddTicks(7547),
                            DateOfEmployment = new DateTime(2021, 6, 18, 8, 36, 13, 779, DateTimeKind.Local).AddTicks(3149),
